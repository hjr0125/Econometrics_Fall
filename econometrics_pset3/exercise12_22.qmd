...
v0_3 <- solve(t(qzx)%*%solve(qzz)%*%qzx)*sig2_3 #variance for 2sls
...
result_d <- data.frame('homoskedastic'=round(c(s0_1[1],s0_2[1],s0_3[1]),2),
                       'heteroskedastic'=round(c(s3[1],s3r[1],se2[1,]),2),
...
Above table is homoskedastic error and heteroskedastic-robust standard errors which calculated in the (a). As the results shown in table, Reports of the S.E. from the paper are the same with my calculation of the homoskedastic S.E. My results say that they reported homoskedastic S.E.
